...
# Standing position of each foot in the body frame
...
class AliengoGaitParams:
  """Parameters for the Aliengo gait controller."""
...
class AliengoGait:
  """Gait controller for Aliengo robot."""
...
# Default gait parameters for the Aliengo robot
