...
# Adjusted for Aliengo's joint configuration
idxs = [[0, 1, 2], [6, 7, 8]]  # Base and Front-right leg indices
...
plt.tight_layout()
plt.show()
plt.savefig('/home/jl79444/dev/d4po/scripts/aliengo_forces.png')
plt.savefig('/home/jl79444/dev/d4po/scripts/aliengo_forces.pdf', format='pdf', bbox_inches='tight') 