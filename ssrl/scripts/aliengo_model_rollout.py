...
def validate_model(cfg: DictConfig):
    ...
    from brax.envs.aliengo_go_fast import AliengoGoFast  # This needs to be created
    from brax.robots.aliengo import networks as aliengo_networks  # This needs to be created
    ...
    wandb.init(project=('aliengo_ssrl_model_validate'),
               entity=cfg.wandb.entity,
               config=config_dict)

    # create env fn
    env_dict = {'AliengoGoFast': AliengoGoFast}
